...
// Import demo database for fallback
const { demoDB } = require('./demo');
...
const db = {
  ...
  async find(table, filters = {}) {
    try {
      ...
      console.log(`⚠️  Supabase query failed for ${table}, using demo data`);
      return demoDB.find(table, filters);
    }
  },
  ...
  async findById(table, id) {
    try {
      ...
      console.log(`⚠️  Supabase query failed for ${table}, using demo data`);
      return demoDB.findById(table, id);
    }
  },
  ...
  async create(table, data) {
    try {
      ...
      console.log(`⚠️  Supabase create failed for ${table}, using demo data`);
      return demoDB.create(table, data);
    }
  },
  ...
  async update(table, id, data) {
    try {
      ...
      console.log(`⚠️  Supabase update failed for ${table}, using demo data`);
      return demoDB.update(table, id, data);
    }
  },
  ...
  async delete(table, id) {
    try {
      ...
      console.log(`⚠️  Supabase delete failed for ${table}, using demo data`);
      return demoDB.delete(table, id);
    }
  },
